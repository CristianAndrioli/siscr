"""
Comando Django para verificar e corrigir migrações do app accounts
Uso: python manage.py fix_accounts_migrations
"""
...
class Command(BaseCommand):
    help = 'Verifica e corrige migrações do app accounts'

    def handle(self, *args, **options):
        self.stdout.write("🔍 Verificando migrações do app accounts...")
        
        # Tabelas do accounts que devem ter colunas do SiscrModelBase
        tables_to_check = [
