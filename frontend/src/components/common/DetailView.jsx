 ...
 * 
 * @param {Object} props
 * @param {Object} props.data - Dados do registro
 * @param {Array} props.fields - Configuração dos campos [{key, label, render?}]
 * @param {Array} props.relatedRecords - Configuração de registros relacionados
 ...
 * @param {string} props.title - Título do registro
 * @param {string} props.subtitle - Subtítulo do registro
 */
