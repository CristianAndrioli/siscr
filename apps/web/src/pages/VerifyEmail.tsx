...
export default function VerifyEmail() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-950">
        <div className="text-center space-y-4">
          <svg className="animate-spin w-10 h-10 text-brand-400 mx-auto" fill="none" viewBox="0 0 24 24">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4">
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-10 max-w-md w-full text-center space-y-5">
        ...
        <a
          href="/signup"
          className="inline-block bg-brand-600 hover:bg-brand-500 text-white font-semibold px-6 py-2.5 rounded-lg transition-colors text-sm"
        >
