...
const BASE = '/cadastros/unidades-medida';
    ...
    >
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-white dark:bg-slate-900 rounded-xl border border-dashed border-slate-300 dark:border-slate-700">
          ...
          <Button variant="primary" size="sm" onClick={() => navigate(`${BASE}/novo`)} className="mt-4">Criar primeira unidade</Button>
        </div>
      ) : (
                ...
                >
                  ...
                  <td className="px-4 py-2.5 text-right" onClick={e => e.stopPropagation()}>
                    <div className="flex gap-1 justify-end">
                      <button onClick={() => navigate(`${BASE}/${u.id}`)} className="w-8 h-8 inline-flex items-center justify-center rounded-lg text-slate-400 hover:text-brand-600 hover:bg-brand-50 dark:hover:text-brand-400 dark:hover:bg-brand-950 transition-colors" title="Editar">
