...
LOGGING = {
    ...
    'root': {
        ...
        'level': 'WARNING' if 'test' in sys.argv else 'INFO',  # Reduzir logs durante testes
    },
    'loggers': {
        'django': {
            'handlers': ['console', 'file'],
        ...
        'django.core.management': {
            'handlers': ['console'],
            'level': 'WARNING' if 'test' in sys.argv else 'INFO',  # Suprimir logs de migrations durante testes
            'propagate': False,
        },
        'siscr': {
            'handlers': ['console', 'file'],
